...
-- tenant-separated by location_id. Shares the persistent_identity_seq emulation table (created in
...
CREATE TABLE song_library_folders (
    ...
    source_id                INT,                   -- scan-local id; NULL for ROOT
    name                      VARCHAR(500) NOT NULL,
    CONSTRAINT fk_song_library_folders_location FOREIGN KEY (location_id) REFERENCES locations (persistent_identity),
    CONSTRAINT fk_song_library_folders_parent FOREIGN KEY (parent_folder_id) REFERENCES song_library_folders (persistent_identity),
...
CREATE TABLE song_library_files (
    ...
    source_id                INT,                   -- scan-local song id; NULL for the 3 singleton file types
    name                      VARCHAR(500) NOT NULL,
    ...
    CONSTRAINT fk_song_library_files_location FOREIGN KEY (location_id) REFERENCES locations (persistent_identity),
    CONSTRAINT fk_song_library_files_parent FOREIGN KEY (parent_folder_id) REFERENCES song_library_folders (persistent_identity),
