 ...
 *
 * <p>
 * This bean is only active when {@code user-interface.enabled=true}. On startup it pushes a
 ...
 */
@Component
@ConditionalOnProperty(name = "user-interface.enabled", havingValue = "true")
